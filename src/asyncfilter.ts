...
export namespace AsyncFilter
{
    ...
    /* PREDICATE*/
    export const randomElement: AsyncPredicate<number> = async (item) => {
    ...
    // Callback
    export function onFilterDone(error: Error | null, result: Array<number> | null) {
        if (error) {
